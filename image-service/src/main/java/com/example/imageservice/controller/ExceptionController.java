...
import com.example.imageservice.exception.ImageException;
import com.example.imageservice.response.ErrorResponse;
...
public class ExceptionController {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> userException(ImageException e) {
